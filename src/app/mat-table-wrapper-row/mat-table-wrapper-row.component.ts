...
@Component({
  selector: 'app-mat-table-wrapper-row',
  templateUrl: './mat-table-wrapper-row.component.html',
  styleUrl: './mat-table-wrapper-row.component.scss',
})
export class MatTableWrapperRowComponent {
